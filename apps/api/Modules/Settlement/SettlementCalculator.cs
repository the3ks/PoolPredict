...
public sealed class SettlementCalculator
{
    ...
    private static SettlementOutcome Evaluate(SettlementCalculationInput input)
    {
        ...
        {
            MarketType.OneXTwo => EvaluateOneXTwo(input.SelectedOption, input.HomeParticipant, input.AwayParticipant, homeScore, awayScore),
    ...
    private static SettlementOutcome EvaluateOneXTwo(
