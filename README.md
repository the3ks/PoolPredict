...
```powershell
dotnet run --project apps/api/PoolPredict.Api.csproj --urls http://localhost:5080
```
...
Later, after persistence, migrations, Redis caching and background jobs are wired in, Docker Compose should become the normal local setup.
